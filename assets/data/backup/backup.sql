...
INSERT INTO `acc_coa` (`HeadCode`, `HeadName`, `PHeadName`, `PHeadCode`, `HeadLevel`, `IsActive`, `IsTransaction`, `IsGL`, `HeadType`, `IsBudget`, `IsDepreciation`, `customer_id`, `supplier_id`, `bank_id`, `service_id`, `DepreciationRate`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`) VALUES ('21110000001', '1-Ali', 'Suppliers', NULL, '4', '1', '1', '0', 'L', '0', '0', NULL, '1', NULL, NULL, '0.00', '1', '2022-08-24 10:07:40', '', '0000-00-00 00:00:00');
...
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('1', '20220824101930', 'Purchase', '2022-08-24', '1141', 'Inventory Debit For Supplier Ali', '960000.00', '0.00', '1', '0', '1', '2022-08-24 10:19:30', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('2', '20220824101930', 'Purchase', '2022-08-24', '21110000001', 'Supplier .Ali', '0.00', '960000.00', '1', '0', '1', '2022-08-24 00:00:00', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('3', '20220824101930', 'Purchase', '2022-08-24', '21110000001', 'Supplier .Ali', '960000.00', '0.00', '1', '0', '1', '2022-08-24 00:00:00', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('4', '20220824101930', 'PurchasePayment', '2022-08-24', '111000001', 'Paid amount for Supplier  Ali', '0.00', '960000.00', '1', '0', '1', '2022-08-24 10:19:30', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('5', '4765959294', 'INV', '2022-08-24', '1141', 'Inventory credit For Invoice No', '0.00', '800.00', '1', '0', '1', '2022-08-24 16:21:12', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('6', '4765959294', 'INV', '2022-08-24', '113100000001', 'Customer debit For Invoice No -   Customer walking customer', '900.00', '0.00', '1', '0', '1', '2022-08-24 16:21:12', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('7', '4765959294', 'INV', '2022-08-24', '511001', 'Product Sales revenue For Invoice NO -  Customer walking customer', '0.00', '900.00', '1', '0', '1', '2022-08-24 16:21:12', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('8', '4765959294', 'INV', '2022-08-24', '2114', 'Value added tax For Invoice NO -  Customer walking customer', '0.00', '0.00', '1', '0', '1', '2022-08-24 16:21:12', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('9', '4765959294', 'INV', '2022-08-24', '113100000001', 'Customer credit for Paid Amount For Customer Invoice NO-  Customer- walking customer', '0.00', '900.00', '1', '0', '1', '2022-08-24 16:21:12', NULL, NULL, '1');
INSERT INTO `acc_transaction` (`ID`, `VNo`, `Vtype`, `VDate`, `COAID`, `Narration`, `Debit`, `Credit`, `IsPosted`, `is_opening`, `CreateBy`, `CreateDate`, `UpdateBy`, `UpdateDate`, `IsAppove`) VALUES ('10', '4765959294', 'INVOICEPayment', '2022-08-24', '111000001', 'Paid amount for customer  Invoice No -  customer -walking customer', '900.00', '0.00', '1', '0', '1', '2022-08-24 16:21:12', NULL, NULL, '1');
...
INSERT INTO `customer_information` (`customer_id`, `customer_name`, `customer_address`, `address2`, `customer_mobile`, `customer_email`, `email_address`, `contact`, `phone`, `fax`, `city`, `state`, `zip`, `country`, `status`, `create_date`, `create_by`) VALUES ('1', 'walking customer', '', '', '', '', '', '', '', '', '', '', '', '', '1', '2022-01-25 08:50:20', '2');
...
INSERT INTO `invoice` (`id`, `invoice_id`, `customer_id`, `date`, `total_amount`, `paid_amount`, `due_amount`, `prevous_due`, `shipping_cost`, `invoice`, `offline_invoice_no`, `invoice_discount`, `total_discount`, `total_vat_amnt`, `total_tax`, `sales_by`, `invoice_details`, `is_credit`, `is_fixed`, `is_dynamic`, `status`, `bank_id`, `payment_type`, `is_online`) VALUES ('1', '4765959294', '1', '2022-08-24', '900.00', '900.00', '0.00', '0.00', '0.00', '1000', NULL, '0.00', '0.00', '0.00', NULL, '1', 'Thank you for shopping with us', '0', '1', '0', '1', NULL, '1', '1');
...
INSERT INTO `product_information` (`id`, `product_id`, `category_id`, `product_name`, `price`, `unit`, `tax`, `serial_no`, `product_vat`, `product_model`, `product_details`, `image`, `status`) VALUES ('1', 'KB-66334', '1', 'Keyboard', '900', 'PCS', '0', 'KB-66334', '0', 'Acer', '', 'my-assets/image/product.png', '1');
...
INSERT INTO `product_purchase` (`id`, `purchase_id`, `chalan_no`, `supplier_id`, `grand_total_amount`, `paid_amount`, `due_amount`, `total_discount`, `invoice_discount`, `total_vat_amnt`, `purchase_date`, `purchase_details`, `status`, `bank_id`, `payment_type`, `is_credit`) VALUES ('1', '20220824101930', '1122', '1', '960000.00', '960000.00', '0.00', '0.00', '0.00', '0.00', '2022-08-24', 'zxc', '1', NULL, '1', '0');
...
INSERT INTO `product_purchase_details` (`id`, `purchase_detail_id`, `purchase_id`, `product_id`, `quantity`, `rate`, `batch_id`, `expiry_date`, `total_amount`, `discount`, `discount_amnt`, `vat_amnt_per`, `vat_amnt`, `status`) VALUES ('1', '89BM1FW8JKA7E96', '20220824101930', 'KB-66334', '1200.00', '800.00', '1122', '0000-00-00', '960000.00', '0', '0.00', '0.00', '0.00', '1');
...
INSERT INTO `supplier_information` (`supplier_id`, `supplier_name`, `address`, `address2`, `mobile`, `emailnumber`, `email_address`, `contact`, `phone`, `fax`, `city`, `state`, `zip`, `country`, `details`, `status`) VALUES ('1', 'Ali', '', '', '', '', '', '', '', '', '', '', '', '', NULL, '1');
...
INSERT INTO `supplier_product` (`supplier_pr_id`, `product_id`, `products_model`, `supplier_id`, `supplier_price`) VALUES ('1', 'KB-66334', 'Acer', '1', '800');
...
INSERT INTO `web_setting` (`setting_id`, `logo`, `invoice_logo`, `favicon`, `currency`, `timezone`, `currency_position`, `footer_text`, `language`, `rtr`, `captcha`, `is_qr`, `site_key`, `secret_key`, `discount_type`) VALUES ('1', '', '', '', '$', 'Asia/Karachi', '0', 'Developed by  Monedge Solutions.', 'english', '0', '1', '1', '6LdiKhsUAAAAAMV4jQRmNYdZy2kXEuFe1HrdP5tt', '6LdiKhsUAAAAAMV4jQRmNYdZy2kXEuFe1HrdP5tt', '1');
