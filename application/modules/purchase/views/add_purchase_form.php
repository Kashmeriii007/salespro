                    ...
                    <table class="table table-bordered table-hover" id="purchaseTable">
                        ...
                        <tbody id="addPurchaseItem">
                            <tr>
                                ...
                                <td class="wt">
                                    <input type="text" id="expiry_date_1" class="form-control expiry_date_1"
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="grandTotal" class="text-right form-control grandTotalamnt"
                                        name="grand_total_price" value="00" readonly />
                                </td>
                                <td> </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="paidAmount" class="text-right form-control"
                                        onKeyup="invoice_paidamount()" name="paid_amount" value="" />
                                </td>
                                <td> </td>
                            </tr>
                            <tr>
