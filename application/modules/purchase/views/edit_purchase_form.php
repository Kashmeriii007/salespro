                            ...
                            <div class="" id="add_new_payment">
                                ...
                                <div class="row no-gutters">
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php 
                                                    echo form_dropdown('multipaytype[]',$all_pmethod,(!empty($all_paytype)?$all_paytype->COAID:null),'class="card_typesl postform resizeselect form-control "') ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="pamount_by_method"
                                            ...
                                            value="<?php echo $all_paytype->Credit?>" onkeyup="changedueamount()"
                                            placeholder="0" />
