    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                         ...
                         <?php echo  form_open_multipart('account/account/create_service_payment','id="create_service_payment"') ?>
                     ...
                     <div class="form-group row">
                            ...
                            <table class="table table-bordered table-hover" id="debtAccVoucher"> 
                              ...
                              <th class="text-center"><?php echo display('amount')?><i class="text-danger">*</i></th>
                                ...
                                <tbody id="debitvoucher">
                                    ...
                                    <tr>
                                        <td class="" width="300">  
                           <select name="customer_id" id="customer_id_1" class="form-control" onchange="load_customer_service_code(this.value,1)" required>
                       ...
                       <option value="<?php echo html_escape($customer->customer_id);?>"><?php echo html_escape($customer->customer_name);?></option>
                             <?php }?>
                                        ...
                                        <td><input type="number" step="0.01" name="txtAmount" value="" class="form-control total_price text-right"  id="txtAmount_1" onkeyup="CustomerServiceRcvcalculation(1)" required>
                                           </td>
...
$(document).on('click','#add_new_payment_type',function(){
    ...
    var url= base_url + "account/account/bdtask_showpaymentmodal";
    $.ajax({
      type: "GET",
      url: url,
...
function customerservicevoucher_due(id) {
   ...
   var csrf_test_name = $('[name="csrf_test_name"]').val();
    $.ajax({
        url : base_url + "account/account/customer_service_voucher_due_amount",
        type: "POST",
        data: {
             invoice_id: id,
