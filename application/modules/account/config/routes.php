...
$route['add_payment_method']   = "account/account/bdtask_payment_method_form";
$route['edit_payment_method/(:num)']   = "account/account/bdtask_payment_method_form/$1";
$route['add_payment_method/(:num)']   = "account/account/bdtask_payment_method_form/$1";
