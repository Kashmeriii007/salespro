    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview <?php
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == ("voucher_list")){
                        ...
                        href="<?php echo base_url('voucher_list') ?>"><?php echo display('voucher_approval'); ?></a>
                </li>
                <?php }?>
                ...
                <li class="treeview <?php
                    ...
                    <ul class="treeview-menu">
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('inventory_ledger') ?>"><?php echo display('Inventory_ledger'); ?></a>
                        </li>
                        <?php } ?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('general_ledger_form') ?>"><?php echo display('general_ledger'); ?></a>
                        </li>
                        <?php } ?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('trial_balance_form') ?>"><?php echo display('trial_balance'); ?></a>
                        </li>
                        <?php } ?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('profit_loss_form') ?>"><?php echo display('profit_loss'); ?></a>
                        </li>
        ...
        <li class="treeview <?php
            ...
            ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('manage_benefits') ?>"><?php echo display('manage_benefits') ?></a>
                        </li>
                        <?php }?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('salary_setup') ?>"><?php echo display('add_salary_setup') ?></a>
                        </li>
                        <?php }?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('manage_salary_setup') ?>"><?php echo display('manage_salary_setup') ?></a>
                        </li>
                        <?php }?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('salary_generate') ?>"><?php echo display('salary_generate') ?></a>
                        </li>
                        <?php }?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('manage_salary_generate') ?>"><?php echo display('manage_salary_generate') ?></a>
                        </li>
                        <?php }?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('salary_payment') ?>"><?php echo display('salary_payment') ?></a>
                        </li> <?php }?>
            ...
            ?>">
                    ...
                    if($this->permission1->method('add_expense_item','create')->access()){ ?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('add_expense_item') ?>"><?php echo display('add_expense_item') ?></a>
                        </li>
                        <?php }?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('manage_expense_item') ?>"><?php echo display('manage_expense_item') ?></a>
                        </li>
                        <?php }?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('manage_expense') ?>"><?php echo display('manage_expense') ?></a>
                        </li>
                        <?php } ?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('expense_statement') ?>"><?php echo display('expense_statement') ?></a>
                        </li>
                        <?php }?>
                    </ul>
                </li>
            ...
            ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('add_officeloan_person') ?>"><?php echo display('add_person') ?></a>
                        </li>
                        <?php }?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('add_office_loan_payment') ?>"><?php echo display('add_payment') ?></a>
                        </li>
                        <?php }?>
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('manage_office_loan_person') ?>"><?php echo display('manage_person') ?></a>
                        </li>
                        <?php }?>
                    </ul>
                </li>
            ...
            ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('manage_person') ?>"><?php echo display('manage_person') ?></a>
                        </li>
                        <?php }?>
                    </ul>
                </li>
        ...
        <li class="treeview <?php
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == ("bank_transaction")){
                        ...
                        href="<?php echo base_url('bank_transaction') ?>"><?php echo display('bank_transaction') ?></a>
                </li>
                <?php }?>
        ...
        <li class="treeview <?php
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview <?php if ($this->uri->segment('1') == ("commission") || $this->uri->segment('1') == ("commission_generate")){
                        ...
                        href="<?php echo base_url('commission') ?>"><?php echo display('generate_commission') ?></a>
                </li>
                <?php } ?>
            </ul>
        </li>
        ...
        <li class="treeview <?php
            ...
            ?>">
                ...
                <!-- sms menu start -->
                <li
                    class="treeview <?php if ($this->uri->segment('1') == ("sms_setting")) { echo "active";}else{ echo " ";}?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('sms_setting')?>"><?php echo display('sms_configure'); ?></a>
                        </li>
