                ...
                foreach($invoice_all_data as $invoice_data){?>
                                <tr>
                                    <th style="border: 1px solid #000;">
                                        <?php echo html_escape($invoice_data['product_id']);?></th>
                                    <th style="border: 1px solid #000;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th style="text-align: left;"><span
                                            style="font-size: 16px;font-weight: 900;"><?php echo $paid_amount?></span>
                                    </th>
                        ...
                        <div style="margin-bottom: 12px;">
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                                ...
                                <tbody>
                                    <tr>
                                        <?php foreach($p_method_list as $method_list){
                                        $getway_wise_balance = $this->db->select('SUM(Debit) as debit')
                                        ->from('acc_transaction')
                                        ->where('VNo',$invoice_id)
                                        ->where('Vtype','INVOICEPayment')
                                        ->where('COAID',$method_list->HeadCode)
                                        ->get()
                                        ->row();
                                        ?>
                                        <th style="text-align: center;">
                                            <?php if($getway_wise_balance->debit !=null){echo $getway_wise_balance->debit;}else{echo '0.00';}?>
                                        </th>
                                        <?php }?>
                                    </tr>
                                </tbody>
